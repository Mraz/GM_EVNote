...
@dynamic currentTime;
@dynamic premium;
@dynamic premiumRecurring;
@dynamic premiumExpirationDate;
@dynamic premiumExtendable;
@dynamic premiumPending;
@dynamic premiumCancellationPending;
@dynamic canPurchaseUploadAllowance;
@dynamic sponsoredGroupName;
@dynamic sponsoredGroupRole;
#endif
